...
make -j4 -f make.rpi $1 ARCH=arm \
	...
	LDFLAGS="-pthread -lm -L"$ARM_LIBS" -lvchostif -lvmcs_rpc_client -lvcfiled_check -lbcm_host -lkhrn_static -lvchiq_arm -lopenmaxil -L/opt/vc/lib/ -lEGL -lGLESv2 -lvcos -lrt -lSDL"
